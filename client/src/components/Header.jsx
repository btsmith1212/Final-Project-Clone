...
function Header() {
    ...
    return (
        <>
            <header className={`fixed top-0 left-0 w-60 flex h-full bg-gray z-20 header ${hamburger && isMobile ? "open" : ""}`}>
            ...
            {isMobile && (
            <>
            <div className="fixed top-0 sm:hidden flex w-full justify-between items-center px-5 py-4 bg-gray">
