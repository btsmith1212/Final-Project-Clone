    ...
    return (
        <div className="w-full h-full flex flex-col justify-center items-center">
            ...
            <form className="flex flex-col items-center justify-center mt-5">
                <input className="px-3 py-2 border border-light-dark w-72" type="text" placeholder="Username" />
                <input className="px-3 py-2 border border-light-dark w-72 mt-3" type="password" placeholder="Password" />
                <input className="px-3 py-2 w-72 mt-3 bg-olive text-white cursor-pointer" type="submit" value={page === "Login" ? "Login" : "Signup"} />
            </form>
