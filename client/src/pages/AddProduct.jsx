...
function ProductPost () {
    ...
    return (
        <section className="flex flex-col justify-center items-center py-16 pl-2 pr-4">
            ...
            <form className="flex flex-row flex-wrap max-w-xl mt-16" onSubmit={handleSubmit}>
                ...
                <div className="w-full">
                    <button type="submit" className="block mx-auto mt-5 px-10 py-4 bg-olive rounded-lg text-white text-center">Submit</button>
                </div>
            </form>
        </section>
    );
